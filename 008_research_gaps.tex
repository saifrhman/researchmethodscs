...
Evidence from this scoping review indicates that such cross-region generalisation is rarely examined in practice. As illustrated in Figure~\ref{fig:regional_bias}, the majority of reviewed studies perform single-region evaluation (23 studies), while a further 16 consider multiple regions without explicitly testing model transfer across geographic domains. Only two studies explicitly investigate cross-region transfer learning or domain adaptation. Table~\ref{tab:transferability} further shows that transferability-focused studies are sparsely distributed across major digital libraries, highlighting the limited attention given to this issue in the mangrove literature.

Among the few studies addressing transferability, Fu et al.~\cite{fu_cross-scenario_2025} employ domain-adaptive transfer learning to estimate mangrove leaf nitrogen and phosphorus content across multiple regions. While their results demonstrate the potential of transfer learning to mitigate performance degradation, the analysis focuses on narrow biochemical traits derived from hyperspectral and multispectral data rather than broader ecosystem properties relevant to restoration planning. Consequently, the extent to which such approaches generalise to structural, hydrological, or multi-modal forest assessment remains unclear.

This imbalance has direct implications for restoration-oriented applications. Models trained predominantly on data-rich regions, particularly in Asia, risk encoding region-specific correlations rather than ecologically invariant representations. Addressing regional bias is therefore essential for both scientific validity and operational scalability, requiring systematic cross-region benchmarking, explicit reporting of performance under domain shift, and the incorporation of transfer learning or domain-aware evaluation protocols into future mangrove restoration frameworks.
