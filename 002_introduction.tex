...
Mangrove forests are among the most productive and valuable coastal ecosystems, performing essential ecological functions such as shoreline stabilisation, storm surge attenuation, carbon sequestration, nutrient cycling, and biodiversity support \cite{leal_state_2024}. 

Mangroves also serve as natural coastal defence barriers, providing protection against tidal erosion and storm surges while functioning as habitats for numerous species of fish and birds. In doing so, they support coastal communities worldwide and contribute significantly to global fisheries \cite{leal_state_2024}.

Despite their importance, as highlighted in \textit{The State of the World’s Mangroves 2024}, these ecosystems continue to experience widespread degradation driven by aquaculture expansion, coastal development, altered hydrological regimes, pollution, and climate-induced stressors, including sea-level rise and increasing temperature extremes \cite{leal_state_2024}.
...
Collectively, this body of work has significantly advanced the ability to observe mangrove forests across multiple spatial and temporal scales.
...
A scoping review approach is appropriate for this study because the literature on mangrove restoration spans diverse datasets, sensing technologies, and computational methods, with heterogeneous objectives, study designs, and evaluation metrics that preclude narrow systematic synthesis. Accordingly, this paper aims to identify methodological trends and highlight research gaps within the current ecological and computational frameworks applied to mangrove ecosystems.

This review does not propose or evaluate a specific computational model. Instead, it synthesises existing evidence to identify limitations in current practice and to outline future research directions for mangrove ecosystem analysis.

As will be discussed in subsequent sections, strong regional bias limits model generalisation across diverse ecological contexts, and the absence of unified multimodal forest frameworks capable of integrating complementary geospatial data constrains the development of holistic and decision-relevant assessments. These limitations hinder the timely and scalable application of computational tools for mangrove restoration planning.
