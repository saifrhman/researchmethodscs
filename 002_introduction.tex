...
Mangrove forests are among the most productive and valuable coastal ecosystems, performing essential ecological functions such as shoreline stabilisation, storm surge attenuation, carbon sequestration, nutrient cycling, and providing habitat for highly diverse biological communities \cite{leal_state_2024}. 
...
As discussed in subsequent sections, several recurring methodological and data-related limitations emerge across the reviewed literature, which collectively constrain the scalability and restoration relevance of current mangrove ecosystem assessment approaches.