...
\item To identify the most common technologies used for mangrove identification and conservation, which implies understanding the benefits and limitations of each one of them.
\item To identify the current computational models used to analyse these datasets and gauge their performance metrics.
\item To outline the current challenges of measurement tools and computational analysis methods, taking into account recent datasets and its results after analysis.\cite{li_mapping_2021}
\item TThe five main objectives of this paper are:
\begin{enumerate}
