...
Despite methodological advances, global mangrove datasets remain subject to several limitations. Differences in sensor selection, classification algorithms, training data, and mangrove definitions lead to discrepancies in mapped extent, particularly near latitudinal range limits and in transitional ecosystems \cite{leal_state_2024}. Temporal gaps between dataset updates may obscure short-term disturbances or rapid regeneration events, while most global products prioritise extent over structural or functional attributes.
